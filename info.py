...
USERNAME = environ.get("USERNAME", "AinFilmContactbot")  # ADMIN USERNAME

# Database Channel
CHANNELS = [
    int(ch) if id_pattern.search(ch) else ch
    for ch in environ.get("CHANNELS", "-1002949824748 -1002955511806").split()
]
...
# Other Channel's
SUPPORT_GROUP = int(environ.get("SUPPORT_GROUP", "-1002985893060"))
DELETE_CHANNELS = int(environ.get("DELETE_CHANNELS", "0"))
request_channel = environ.get("REQUEST_CHANNEL", "-1002985893060")
REQUEST_CHANNEL = (
    int(request_channel)
    if request_channel and id_pattern.search(request_channel)
    else None
)
MOVIE_UPDATE_CHANNEL = int(environ.get("MOVIE_UPDATE_CHANNEL", "-1003083233572"))

# Added Link Here Not Id
SUPPORT_CHAT = environ.get("SUPPORT_CHAT", "https://t.me/+P6yT0OFWxD1kMWY1")
MOVIE_GROUP_LINK = environ.get("MOVIE_GROUP_LINK", "https://t.me/Ain_movie4u")

# Verification
IS_VERIFY = is_enabled("IS_VERIFY", True)
# ---------------------------------------------------------------
TUTORIAL = environ.get("TUTORIAL", "https://t.me/udhvfrf/30")
TUTORIAL_2 = environ.get("TUTORIAL_2", "https://t.me/udhvfrf/30")
TUTORIAL_3 = environ.get("TUTORIAL_3", "https://t.me/udhvfrf/30")
VERIFY_IMG = environ.get(
    "VERIFY_IMG", "https://graph.org/file/1669ab9af68eaa62c3ca4.jpg"
)
SHORTENER_API = environ.get("SHORTENER_API", "b811a428bebd4da5c4179fdb8b8d2b65f00ea908")
SHORTENER_WEBSITE = environ.get("SHORTENER_WEBSITE", "Shortxlinks.com")
SHORTENER_API2 = environ.get(
    "SHORTENER_API2", "b811a428bebd4da5c4179fdb8b8d2b65f00ea908"
)
SHORTENER_WEBSITE2 = environ.get("SHORTENER_WEBSITE2", "Shortxlinks.com")
SHORTENER_API3 = environ.get(
    "SHORTENER_API3", "b811a428bebd4da5c4179fdb8b8d2b65f00ea908"
)
